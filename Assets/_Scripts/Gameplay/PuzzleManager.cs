...
public class PuzzleManager : MonoBehaviour
{
    ...
    private void Vitoria()
    {
        ...
        if (AudioManager.instance != null) AudioManager.instance.TocarSFX(AudioManager.instance.somVitoria);
    ...
    public void Derrota()
    {
        ...
        if (AudioManager.instance != null) AudioManager.instance.TocarSFX(AudioManager.instance.somDerrota);
